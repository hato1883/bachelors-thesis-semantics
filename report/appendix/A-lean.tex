...
lemma seq_exec_preserve_right {S₁ S₂ : Stmt} {s s' : State} {k : Nat}
  ...
  | succ k ih =>
    ...
    | step h_step h_rest =>
      ...
      cases @\gamma@' with
      | final s_next =>
        -- Case 1: S₁ finishes in one step (@\gamma@' = s_next)
...
lemma small_step_k_to_star {@\gamma@₁ @\gamma@₂ : Config} {k : Nat}
  (h : small_step_k @\gamma@₁ k @\gamma@₂) : small_step_star @\gamma@₁ @\gamma@₂ := by
  induction h with
  | refl => exact small_step_star.refl
  | step s h_rest ih => exact small_step_star.step s ih


lemma star_to_small_step_k {@\gamma@₁ @\gamma@₂ : Config}
  (h : small_step_star @\gamma@₁ @\gamma@₂) : @\exists@ k, small_step_k @\gamma@₁ k @\gamma@₂ := by
  induction h with
  | refl =>
    exists 0
...
lemma small_step_star_trans {@\gamma@₁ @\gamma@₂ @\gamma@₃ : Config}
  (h_left : small_step_star @\gamma@₁ @\gamma@₂) (h_right : small_step_star @\gamma@₂ @\gamma@₃) :
  small_step_star @\gamma@₁ @\gamma@₃ := by
