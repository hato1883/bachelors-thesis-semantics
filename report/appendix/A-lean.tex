...
All code used in this thesis can be found on the public GitHub repository \href{https://github.com/hato1883/Bachelor-Thesis-Code}{hato1883/Bachelor-Thesis-Code}.
This section contains some extra proofs that are needed in some situations in assignments of the book.
...
Here is the lean4 code used to prove Exercise 2.21, it can also be found in the public github repository at \href{https://github.com/hato1883/Bachelor-Thesis-Code/blob/main/Proofs/exercise_2_21.lean}{hato1883/Bachelor-Thesis-Code}
\begin{Lean_Code}
/-!
...
lemma seq_exec_preserve_right {S§\(_1\)§ S§\(_2\)§ : Stmt} {s s' : State} {k : Nat}
  ...
  | zero =>
    -- §\(\langle\)§S§\(_1\)§, s§\(\rangle\)§ §\(\to_{sos}\)§[0] s' is impossible because Step \(\neq\) Final
    cases h
  | succ k ih =>
