...
First steps before reasoning whether or not Natural Semantics and Structural Operational Semantics are equivalent is to create them.
and to create them we also need a language to apply them to, in our case this will be \While.
...
We will start by defining the natural operational semantics often referred to as "big step semantics".
...
\begin{quotation}
\noindent
For every statement S of \While, we have \(\mathcal{S}_{ns}[\![S]\!] = \mathcal{S}_{sos}[\![S]\!]\).
