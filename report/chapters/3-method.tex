...
\begin{prooftree}
  \hypo{} % Empty hypothesis for an axiom
  \infer[left label=[skip$_{\text{sos}}$]]1{ \langle \textbf{skip}, s \rangle \to s}
\end{prooftree}
            \)
    \end{rightcolumn}
    \vspace{1em}
...
\begin{prooftree}
  ...
  \infer[
    ...
    if $\mathcal{B}[\![b]\!]s = \mathbf{tt}$
        ...
        \parbox{4cm}{$
    \langle \textbf{if}\ b\ \textbf{then}\ S_1\ \textbf{else}\ S_2, s \rangle \to \langle S_1, s\rangle
        $}
    }
\end{prooftree}
            \)
...
\begin{prooftree}
  ...
  \infer[
    ...
    if $\mathcal{B}[\![b]\!]s = \mathbf{ff}$
        ...
        \parbox{4cm}{$
    \langle \textbf{if}\ b\ \textbf{then}\ S_1\ \textbf{else}\ S_2, s \rangle \to \langle S_2, s\rangle
        $}
    }
\end{prooftree}
            \)
  ...
  \infer[
      left label={[while$_{\text{sos}}$]}
        ...
        \parbox{4cm}{$
            ...
            \langle \textbf{if}\ b\ \textbf{then}\ (S;\ \textbf{while}\ b\ \textbf{do}\ S)\ \textbf{else}\ \textbf{skip}, s \rangle
        $}
    }
\end{prooftree}
            \)
