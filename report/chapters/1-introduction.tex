...
(1DL311)" which uses the literature "Semantics with Applications: An Appetizer" \hampus{cite book} \missingcitation \todo{Add citation for Nielson and Nielson (2007)}.
